...
------------------------------------------------------------------------------*/
     ...
     * @param pstrDefault the default value for the property to be retrieved.  
     * @return the string property value.
     */
    public String getStringProperty(String pstrSection, String pstrProp, String pstrDefault)
    {
        String      strRet   = null;
     ...
     * @param pstrSection the INI section name.
     * @param pstrProp the property to be retrieved.
     * @param bDefault the default value for the property to be retrieved.  
     * @return the boolean value
     */
    public Boolean getBooleanProperty(String pstrSection, String pstrProp, boolean bDefault)
    {
       // boolean     blnRet  = false;
    	boolean     blnRet  = bDefault;
        String      strVal  = null;
        INIProperty objProp = null;
        INISection  objSec  = null;
     ...
     * @param pstrSection the INI section name.
     * @param pstrProp the property to be retrieved.
     * @param iDefault the default value for the property to be retrieved.
     * @return the integer property value.
     */
    public Integer getIntegerProperty(String pstrSection, String pstrProp, int iDefault)
    {
        Integer     intRet  = iDefault;
        String      strVal  = null;
        INIProperty objProp = null;
        INISection  objSec  = null;
     ...
     * @param pstrSection the INI section name.
     * @param pstrProp the property to be retrieved.
     * @param lDefault the default value for the property to be retrieved.
     * @return the long property value.
     */
    public Long getLongProperty(String pstrSection, String pstrProp, long lDefault)
    {
        Long        lngRet  = lDefault;
        String      strVal  = null;
        INIProperty objProp = null;
        INISection  objSec  = null;
     ...
     * @param pstrSection the INI section name.
     * @param pstrProp the property to be retrieved.
     * @param dDefault the default value for the property to be retrieved.
     * @return the double property value.
     */
    public Double getDoubleProperty(String pstrSection, String pstrProp, double dDefault)
    {
        Double      dblRet  = dDefault;
        String      strVal  = null;
        INIProperty objProp = null;
        INISection  objSec  = null;
